    ...
    <section className="relative overflow-hidden py-28 px-6 md:px-16 bg-white dark:bg-[#020617]">
      ...
      <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
        ...
        >
          ...
          >
            I build modern, interactive and fully responsive web
            applications with React, Next.js and Tailwind CSS.
            I love creating smooth user experiences, animated UI,
            clean code architecture and beautiful interfaces.
          </motion.p>
